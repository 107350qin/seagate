...
<div class="nav">
    ...
    <a href="${pageContext.request.contextPath}/admin/latestInfo" style="background-color:#00C4C4;">最新资讯</a>
...
<a href="${pageContext.request.contextPath}/admin/addEvent" class="add" style="color:red;font-weight:normal; text-decoration: underline;">添加最新资讯</a>
        <p class="pa">
            <span>最新资讯</span>
