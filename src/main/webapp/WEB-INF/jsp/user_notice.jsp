...
<div class="all">
    <div class="left">
        ...
        ">公告通知</a>
        <a href="${pageContext.request.contextPath}/user/latestInfo">最新资讯</a>
    </div>
    <div class="right">
        <table  cellspacing="0"  style="width:98.5%">
            <tr style="background-color:#F2F2F2">
                <th style="text-align: left;font-weight: bold;font-size: 18px">公告通知</th>
                <th></th>
                <th style="font-weight: bold;font-size: 18px">共${pager.totalCount}条通知</th>
            </tr>
          
         <c:forEach var="p" begin="0" end="9" items="${pager.content}">
		            <tr>
...
<p class="page">
    ...
    <c:if test="${pager.pageNow>1}">
     <a href="${pageContext.request.contextPath}/user/notice?pageNow=${pager.pageNow-1}" style="text-align:center;line-height:30px;margin-left:10px;display:block;float:left;width:80px;height:30px;background-color:yellow;">
    		上一页
    </a>
    </c:if>
    ...
    <c:if test="${pager.pageNow!=i}">
    <a href="${pageContext.request.contextPath}/user/notice?pageNow=${ i }" style="text-align:center;line-height:30px;margin-left:10px;display:block;float:left;width:30px;height:30px;background-color:red;">
    		${ i }
    </a>
    </c:if>
