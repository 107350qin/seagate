...
<div class="all">
    <div class="left">
        ...
        <a style="background-color: rgb(210, 248, 235);">奖励计划</a>
    </div>
    <div class="right">
        <table  cellspacing="0"  style="width:98.5%">
            <tr style="background-color:#F2F2F2">
                <th style="text-align: left;font-weight: bold;font-size: 18px">奖励计划</th>
          ...
          <c:forEach var="p" items="${pager.content}">
		    <tr>
                ...
                <td style="text-align: center;">${p.event_time}</td>
            </tr>
         </c:forEach>
    ...
    <c:if test="${pager.pageNow>1}">
     <a href="${pageContext.request.contextPath}/user/incentivePlan?pageNow=${pager.pageNow-1}" style="text-align:center;line-height:30px;margin-left:10px;display:block;float:left;width:80px;height:30px;background-color:yellow;">
    		上一页
    </a>
    </c:if>
    ...
    <c:if test="${pager.pageNow!=i}">
    <a href="${pageContext.request.contextPath}/user/incentivePlan?pageNow=${ i }" style="text-align:center;line-height:30px;margin-left:10px;display:block;float:left;width:30px;height:30px;background-color:red;">
    		${ i }
    </a>
    </c:if>
