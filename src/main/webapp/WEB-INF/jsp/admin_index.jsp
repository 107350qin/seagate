...
<div class="nav">
    <a href="${pageContext.request.contextPath}/admin/index" style="background-color:#00C4C4;">公告通知</a>
...
<a href="${pageContext.request.contextPath}/admin/addEvent" class="add" style="color:red;font-weight:normal; text-decoration: underline;">添加公告通知</a>
        <p class="pa">
            <span>公告通知</span>
            <span>共${pager.totalCount}条通知</span>
        </p>
