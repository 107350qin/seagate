...
<a  href="${pageContext.request.contextPath}/com/cancel" class="upload"  style="text-decoration: none;display:fixed;top:0px;left:0px;">退出登录</a>
...
<p class="ch_title" style="display:none;">${ chapter.ch_title }</p>
    <div id="top" style="margin:0 auto;">
        <div id="top1">
            <div id="u2_png">
                <a href="">
                    <img src="${pageContext.request.contextPath}/img/sys/u2.png">
                </a>
            </div>
            <div id="text">
                <a href="">希 捷 精 英 汇</a>
            ...
            <div id="top2" style="margin-top: 50px;float: right;">
                <div id="u31_png">
                    <img src="${pageContext.request.contextPath}/img/sys/u31.png" class="email">
                </div>
                <div id="text2">
                ...
                <div id="top3" style="margin-left: 70px;">
                    <div id="u25_pn">
                        <img src="${pageContext.request.contextPath}/img/sys/u25.png" class="phone">
                    </div>
                    <div id="text3">
 ...
 <div class="main" style="width:100%;height:75%;background-color:#e7e3e3;">
                    ...
                    <c:forEach var="chapter" items="${ course.chapterList }">
                    	<c:if test="${fn:length(chapter.list)>0}">
	                    	...
	                    	<c:forEach var="section" items="${ chapter.list }">
	                    		<a href="${pageContext.request.contextPath}/com/startStudy?c_id=${ course.c_id }&section_id=${ section.section_id }&index=<%=index%>" style="display:block;border-bottom:solid 0.1px white; text-indent:25px;background-color: #434D50;">
