...
<div class="nav">
    ...
    <a href="${pageContext.request.contextPath}/admin/marketActivity" style="background-color:#00C4C4;">市场活动</a>
...
<a href="${pageContext.request.contextPath}/admin/addEvent" class="add" style="color:red;font-weight:normal; text-decoration: underline;">添加市场活动</a>
        <p class="pa">
            <span>市场活动</span>
